...
import {
  GridRowGroupByColumnsGroupingCell,
  GridRowGroupByColumnsGroupingCellValue,
} from '../../../components/cell/GridRowGroupByColumnsGroupingCell';
        ...
        const fullBaseColDef: GridColDef = {
          ...
          valueGetter: ({ rowNode, api }): GridRowGroupByColumnsGroupingCellValue => ({
            ...
            filteredDescendantCount:
              gridFilteredDescendantCountLookupSelector(api.state)[rowNode.id] ?? 0,
          }),
